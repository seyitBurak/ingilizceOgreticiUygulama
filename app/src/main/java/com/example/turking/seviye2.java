...
public class seviye2 extends gericikma implements View.OnClickListener {
    ...
    int puan = 0;
    int toplamsorusayısı = Sorular.soru2.length;
    int dizi = 0;
    int sorusayacı= 0;
    String secilencevap = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button anasayffss = findViewById(R.id.buttonanasayfa);
        anasayffss.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.devam_et) {
            if (secilencevap.equals(Sorular.cevap2[dizi])) {
                puan++;
            }
            dizi++;
            Yenisoru();
    ...
    void Yenisoru() {
        ...
        soruyaz.setText(Sorular.soru2[dizi]);
        asikki.setText(Sorular.sıklar2[dizi][0]);
        bsikki.setText(Sorular.sıklar2[dizi][1]);
        csikki.setText(Sorular.sıklar2[dizi][2]);
        dsikki.setText(Sorular.sıklar2[dizi][3]);
    ...
    void testbitir() {
        ...
        Intent a = new Intent(getApplicationContext(), seviye3.class);
